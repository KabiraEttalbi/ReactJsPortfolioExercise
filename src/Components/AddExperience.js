...
export default function AddExperience({setProjects}) {
    ...
    return (
        ...
        <h3 className="text-xl font-semibold text-gray-700 mb-4">Add an Experience </h3>
        <form
            className="space-y-4"
            onSubmit={(e) => {
            e.preventDefault();
        ...
        >
            ...
            <input
                ...
                className="w-full border border-gray-300 rounded-md p-2 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                placeholder="e.g., DEVAGA LLC - Marrakesh (December 2023 - January 2024)"
            />
            </div>
            <div>
